    ...
    for src_meta in meta_rows:
        ...
        for box in boxes:
            ...
            meta = {
                ...
                "source_sample_id": src_meta.get("source_sample_id"),
                "source_image": src_meta.get("source_image"),
                "source_image_path": src_meta.get("source_image_path", ""),
                "source_mask_path": src_meta.get("source_mask_path", ""),
                "source_lane_path": src_meta.get("source_lane_path", ""),
                "source_intersection_path": src_meta.get("source_intersection_path", ""),
                ...
                "crop_box": crop_box,
                "keep_box": src_meta.get("keep_box", {}),
